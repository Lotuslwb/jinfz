(function () {
    ...
    GLOBAL.Util.getDomain = function(){
        return location.href.match(/jinfuzi\.\w+/);
    };
    ...
    function getUserSrc()
    {
        ...
        var reg = /^http:\/\/\w*\.jinfuzi\./;
        var validRefer = !reg.test(refer) && refer.length > 0;
        if (!validRefer) {
            if(GLOBAL.Util.cookie("JRECORD_SRC") != null){
    ...
    function getSign()
    {
        ...
        return GLOBAL.Util.cookie('JRECORD_SIGN');
    }
    ...
    function getFirstTime()
    {
        ...
        if(GLOBAL.Util.cookie('JRECORD_FTIME') == null)
        {
    ...
    function getLastTime()
    {
        var now = new Date(),
            cru_time = Math.round(now.getTime() / 1000);
        if(GLOBAL.Util.cookie('JRECORD_CTIME') != null)
        {
    ...
    {
        Sjax.load("http://yunying." + GLOBAL.domain + "/report", {
            data:userInfo,
